...
<main class="main">
  <div class="container">
    <section class="wrapper">
      <div class="heading">
        <h1 class="text text-large">Group Sign In</h1>
       
      </div>
      <form name="signin" class="form"  method="POST" action="{{ route('group.group-login') }}">
        @csrf

        <div class="input-control">
          <label for="email" class="input-label" hidden>Group</label>
         <select class="input-field" name="group">
        ...
        <div class="input-control">
          <label for="email" class="input-label" hidden>Member Email Address</label>
        ...
        <div class="input-control">
          ...
          <input type="password" name="password" id="password" class="input-field" placeholder="Group Password">
        </div>
        @error('password')
      ...
      <div class="method-control">
        <a href="{{ route('group.group-signup') }}" class="method-action" style="background-color: #2D496B; border:none;color:#fff">
