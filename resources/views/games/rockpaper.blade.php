    ...
    <div class="container">
        <div class="top_info">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button onclick="{window.location.href='{{url('games')}}'}">Back</button>
                </div>
...
<script>
    ...
    function pickOption(o) {
        if (choice == undefined) {
            ...
            alert("You've already played! click on new game") //Se a pessoa ja jogou, vem um alerta falando que ela não pode jogar de novo | If player already played, comes a alert saying that can't play again
        }
        ingame = 0
    }
