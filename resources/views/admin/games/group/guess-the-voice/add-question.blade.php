    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Add Guess Voice Question</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" enctype="multipart/form-data"  action="{{ route('admin.store-group-guess-voice-question') }}" id="questionForm" >
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
