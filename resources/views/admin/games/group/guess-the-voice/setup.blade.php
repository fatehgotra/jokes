...
@section('title', 'Group - Guess The Voice')
@section('head')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> Group - Guess The Voice </a></li>
                        <li class="breadcrumb-item active">Setup</li>
                    </ol>
                </div>
                <h4 class="page-title">Group - Guess The Voice</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" action="{{ route('admin.store-group-guess-voice') }}" id="courseForm" enctype="multipart/form-data">
        @csrf
