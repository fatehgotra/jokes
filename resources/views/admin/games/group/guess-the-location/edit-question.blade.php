    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Add Group Guess Location Question</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.update-group-guess-location-question') }}" id="questionForm">
        @csrf
