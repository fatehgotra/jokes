    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Add Group Guess Celebrity Question</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.update-group-guess-celebrity-question') }}" id="questionForm">
        @csrf
