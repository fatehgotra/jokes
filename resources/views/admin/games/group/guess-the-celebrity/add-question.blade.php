            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Group Guess  Celebrity Add Question</a></li>
                        <li class="breadcrumb-item active">Setup</li>
                    </ol>
                </div>
                <h4 class="page-title">Add Guess  Celebrity Question</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" enctype="multipart/form-data"  action="{{ route('admin.store-group-guess-celebrity-question') }}" id="questionForm" >
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
