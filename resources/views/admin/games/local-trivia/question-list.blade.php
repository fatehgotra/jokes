            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Local Trivia Questions</a></li>
                        <li class="breadcrumb-item active">Setup</li>
                    </ol>
                </div>
                <h4 class="page-title">Local Trivia Questions</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12 text-end">
                        <a href="{{ route('admin.add-trivia-question') }}" class="btn btn-sm btn-dark float-end">Add
                            Question</a>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.edit-trivia-question', $question->id) }}" class="dropdown-item"><i class="mdi mdi-account-edit-outline"></i>
                                                Edit question</a>
                                            <a href="javascript:void(0);" onclick="confirmDelete({{ $question->id }})" class="dropdown-item"><i class="mdi mdi-trash-can"></i>
                                                Delete
                                                question</a>
                                            <form id='delete-form{{ $question->id }}' action='{{ route('admin.delete-trivia-question', $question->id) }}' method='POST'>
