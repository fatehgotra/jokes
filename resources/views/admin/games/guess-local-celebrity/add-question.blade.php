...
@section('title', 'Guess Local Celebrity')
@section('head')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Guess Local Celebrity Add Question</a></li>
                        <li class="breadcrumb-item active">Setup</li>
                    </ol>
                </div>
                <h4 class="page-title">Add Guess Local Celebrity Question</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" enctype="multipart/form-data"  action="{{ route('admin.store-guess-local-celebrity-question') }}" id="questionForm" >
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_1" id="option_1" placeholder="Option 1" rows="3"> {{ old('option_1') }} </textarea>
                                @error('option_1')
                                <code class="text text-danger">{{ $message }}</code>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_2" id="option_2" placeholder="Option 2" rows="3"> {{ old('option_2') }} </textarea>
                                @error('option_2')
                                <code class="text text-danger">{{ $message }}</code>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_3" id="option_3" placeholder="Option 3" rows="3"> {{ old('option_3') }} </textarea>
                                @error('option_3')
                                <code class="text text-danger">{{ $message }}</code>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_4" id="option_4" placeholder="Option 4" rows="3"> {{ old('option_4') }} </textarea>
                                @error('option_4')
                                <code class="text text-danger">{{ $message }}</code>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select name="correct_option" id="correct_option" class="form-select">
                                    ...
                                    <option value="option_1" @if ( old("correct_option") == "option_1" ? "selected" : '')  @endif >Option 1</option>
                                    <option value="option_2" @if ( old('correct_option') == "option_2" ? "selected" : '' ) @endif>Option 2</option>
                                    <option value="option_3" @if ( old('correct_option') == "option_3" ? "selected" : '' ) @endif>Option 3</option>
                                    <option value="option_4" @if ( old('correct_option') == "option_4" ? "selected" : '' ) @endif>Option 4</option>
                                </select>
