...
@section('title', 'Guess The Local Celebrity')
@section('head')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Guess The Local Celebrity</a></li>
                        <li class="breadcrumb-item active">Setup</li>
                    </ol>
                </div>
                <h4 class="page-title">Guess The Local Celebrity</h4>
            </div>
        </div>
    </div>
...
<div class="row">
    <form method="POST" action="{{ route('admin.store-guess-local-celebrity') }}" id="courseForm" enctype="multipart/form-data">
        @csrf
